...
import menuValues from "../utils/menuNavValues"
		...
		<nav className="flex flex-col">
			...
			<div className={openMenuState.navMenu ? 'block' : 'hidden'}>
				<div className="md:hidden flex flex-col gap-1 p-2 bg-blue-800">
					...
					<div className="flex items-center gap-2 mx-4 px-3 py-2 rounded-full bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset focus:ring-offset-gray-800 focus:ring-white">
					...
					<Link href="/settings">
						<a className="block px-4 py-2 text-sm text-white rounded-md hover:bg-gray-300 hover:text-blue-800" role="menuitem" tabIndex="-1" id="user-menu-item-2">
							Meus dados
						</a>
					</Link>
					...
					<span
						onClick={signOut}
						className="px-4 py-2 text-sm text-white rounded-md hover:bg-gray-300 hover:text-blue-800 cursor-pointer"
					>
						Sair
					</span>
				</div>
