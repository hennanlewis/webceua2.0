...
export function Main(props) {
	...
	return (
		<section className="max-w-[100%] w-auto grow flex justify-center bg-neutral-100">
			<div className="w-[100%] p-4 md:px-6 md:py-5 lg:px-8 lg-py-6">
				{title && <h2 className="text-2xl font-semibold my-6">{title}</h2>}
