...
export function ProjectsTableReviewer(props) {
								...
								<td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
									{
										<Link href={{
											...
											<a className="px-4 py-2 bg-[#005090] text-center font-medium text-white  hover:brightness-125 rounded-md">Analisar</a>
										</Link>
									}
								</td>
							</tr>
